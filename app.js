...
var incompleteTaskHolder=document.querySelector(".tasks_incomplete");//ul of #incomplete-tasks
...
var editTask=function(){
    ...
    //If class of the parent is .task-unit_edit
    if(containsClass){

        //switch to .task-unit_edit
    ...
    //toggle .task-unit_edit on the parent.
